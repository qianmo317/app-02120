  ...
  <div class="recently-viewed-page">
    <div class="container">
      <div class="page-header">
        ...
        <el-button 
          v-if="recentlyViewedStore.count > 0" 
          type="danger" 
          link 
      ...
      <div class="product-grid">
        <template v-if="recentlyViewedStore.sortedItems.length > 0">
          <div v-for="item in recentlyViewedStore.sortedItems" :key="item.productId" class="product-card card">
